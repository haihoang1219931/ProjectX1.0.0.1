...
#define HTTP_USER_AGENT			"Mozilla/5.0 (Windows NT 6.1; WOW64; rv:47.0) Gecko/20100101 Firefox/47.0"
#define HTTP_ACCEPT				"text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8"
#define HTTP_ACCEPT_LANGUAGE	"vi-VN,en;q=0.8,vi;q=0.5,en-US;q=0.3"
#define HTTP_ACCEP_ENCODING		"gzip, deflate"
#define HTTP_DNT				"1"
